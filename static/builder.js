...
function readItemsExcludeInclude() {
    ...
    dataStorage.includeSTMROfOwnedUnits = $("#includeSTMROfOwnedUnits").prop("checked");
...
function onEquipmentsChange() {
    ...
    if (equipments == "all") {
        ...
        $("#includeSTMROfOwnedUnits").parent().addClass("hidden");
        ...
        if (ownedUnits && Object.keys(ownedUnits).length > 0) {
            ...
            $("#includeSTMROfOwnedUnits").parent().removeClass("hidden");
...
function getStateHash(onlyCurrent = true) {
    ...
    var additionalFilters = ["includeSTMROfOwnedUnits","includeEasilyObtainableItems", "includeChocoboItems", "includeTMROfOwnedUnits", "includeTmrMoogles", "includeTrialRewards", "exludeEvent", "excludePremium", "excludeTMR5", "excludeSTMR", "excludeNotReleasedYet"];
...
function oldLinkFormatToNew(oldData) {
    ...
    var additionalFilters = ["includeSTMROfOwnedUnits", "includeTMROfOwnedUnits", "includeTmrMoogles", "includeTrialRewards", "exludeEvent", "excludePremium", "excludeTMR5", "excludeSTMR", "excludeNotReleasedYet"];
    for (var i = 0; i < additionalFilters.length; i++) {
