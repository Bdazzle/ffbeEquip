...
class DataStorage {
    constructor() {
        ...
        this.includeSTMROfOwnedUnits = false;
    ...
    getOwnedNumber(item) {
        ...
        if (this.includeSTMROfOwnedUnits) {
            if (item.stmrUnit && ownedUnits[item.stmrUnit]) {
                totalNumber += ownedUnits[item.stmrUnit].farmable;
            }
        }
